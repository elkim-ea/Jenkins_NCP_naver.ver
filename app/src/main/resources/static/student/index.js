    ...
    .then((result) => {
      ...
      if (student.photo) {
        document.querySelector(
          "#f-photo-origin"
        ).href = `https://kr.object.ncloudstorage.com/dew-helpme911/${student.photo}`;
        document.querySelector(
          "#f-photo"
          // ifbjdjpe12028.edge.naverncp.com/Z82CGv8su5/4e7f6f37-1d30-44e9-9087-9d97e793a359
        ).src = `https://zpgf08du12145.edge.naverncp.com/IdB46iPBjk/${student.photo}?type=f&w=80&h=80&faceopt=true&ttype=jpg`;
      } /*else {
